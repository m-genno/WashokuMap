...
insert into restaurant
  (id, name, name_translations, description, address, location, phone,
   listing_type, reservation_mode, price_range, status, source)
values
  ('11111111-1111-1111-1111-111111111111', '鮨 田中',
   ...
   '03-1111-1111', 'unlisted', 'request', 4, 'published', 'manual'),
  ...
  ('22222222-2222-2222-2222-222222222222', '天ぷら 山田',
   ...
   '03-2222-2222', 'unlisted', 'request', 3, 'published', 'manual'),
  ...
  ('33333333-3333-3333-3333-333333333333', '蕎麦 鈴木',
   ...
   '03-3333-3333', 'listed', 'external', 2, 'published', 'manual'),
  ...
  ('44444444-4444-4444-4444-444444444444', '焼き鳥 佐藤',
   ...
   '03-4444-4444', 'unlisted', 'phone_only', 2, 'published', 'manual'),
  ...
  ('55555555-5555-5555-5555-555555555555', '居酒屋 ほろ酔い',
   ...
   '03-5555-5555', 'unlisted', 'request', 2, 'published', 'manual')
