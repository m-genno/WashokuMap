...
const ja: Dict = {
  ...
  "detail.translated": "訳: ",
  "detail.translate": "翻訳する",
  "detail.translating": "翻訳中…",
  "detail.hideTranslation": "翻訳を隠す",
  "detail.translateFailed": "翻訳できませんでした。",
...
const en: Dict = {
  ...
  "detail.translateFailed": "Could not translate.",
...
const zhHans: Dict = {
  ...
  "detail.hideTranslation": "隐藏译文",
  "detail.translateFailed": "翻译失败。",
...
const zhHant: Dict = {
  ...
  "detail.translate": "翻譯",
  "detail.translating": "翻譯中…",
  "detail.hideTranslation": "隱藏譯文",
  "detail.translateFailed": "翻譯失敗。",
...
const ko: Dict = {
  ...
  "detail.translate": "번역",
  "detail.translating": "번역 중…",
  "detail.hideTranslation": "번역 숨기기",
  "detail.translateFailed": "번역에 실패했습니다.",
